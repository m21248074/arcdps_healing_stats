...
HealTableOptions::HealTableOptions()
{
	...
	snprintf(Windows[0].Name, sizeof(Windows[0].Name), "%s", "總計");
	snprintf(Windows[0].TitleFormat, sizeof(Windows[0].TitleFormat), "%s", "總計 (進入戰鬥{1}秒)");
	snprintf(Windows[0].EntryFormat, sizeof(Windows[0].EntryFormat), "%s", "{1} ({4}/秒)");

	Windows[1].DataSourceChoice = DataSource::Agents;
	snprintf(Windows[1].Name, sizeof(Windows[1].Name), "%s", "目標");
	snprintf(Windows[1].TitleFormat, sizeof(Windows[1].TitleFormat), "%s", "目標 {1} ({4}/秒，進入戰鬥{7}秒)");

	Windows[2].DataSourceChoice = DataSource::Skills;
	snprintf(Windows[2].Name, sizeof(Windows[2].Name), "%s", "技能");
	snprintf(Windows[2].TitleFormat, sizeof(Windows[2].TitleFormat), "%s", "技能 {1} ({4}/秒，進入戰鬥{7}秒)");

	Windows[3].DataSourceChoice = DataSource::Agents;
	snprintf(Windows[3].Name, sizeof(Windows[3].Name), "%s", "目標 (命中數)");
	snprintf(Windows[3].TitleFormat, sizeof(Windows[3].TitleFormat), "%s", "目標 {1} ({5}/每命中, {2} 次命中)");
	snprintf(Windows[3].EntryFormat, sizeof(Windows[3].EntryFormat), "%s", "{1} ({5}/每命中, {2} 次命中)");
	snprintf(Windows[3].DetailsEntryFormat, sizeof(Windows[3].DetailsEntryFormat), "%s", "{1} ({5}/每命中, {2} 次命中)");

	Windows[4].DataSourceChoice = DataSource::Skills;
	snprintf(Windows[4].Name, sizeof(Windows[4].Name), "%s", "技能 (命中數)");
	snprintf(Windows[4].TitleFormat, sizeof(Windows[4].TitleFormat), "%s", "技能 {1} ({5}/每命中, {2} 次命中)");
	snprintf(Windows[4].EntryFormat, sizeof(Windows[4].EntryFormat), "%s", "{1} ({5}/每命中, {2} 次命中)");
	snprintf(Windows[4].DetailsEntryFormat, sizeof(Windows[4].DetailsEntryFormat), "%s", "{1} ({5}/每命中, {2} 次命中)");

	Windows[5].DataSourceChoice = DataSource::PeersOutgoing;
	snprintf(Windows[5].Name, sizeof(Windows[5].Name), "%s", "隊員輸出治療");
	snprintf(Windows[5].TitleFormat, sizeof(Windows[5].TitleFormat), "%s", "輸出治療 {1} ({4}/秒，進入戰鬥{7}秒)");
	...
	snprintf(Windows[9].Name, sizeof(Windows[9].Name), "%s", "綜合");
	snprintf(Windows[9].TitleFormat, sizeof(Windows[9].TitleFormat), "%s", "綜合 {1} ({4}/秒，進入戰鬥{7}秒)");
}
